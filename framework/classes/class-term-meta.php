    ...
    class Term_Meta{
		...
		static function checkbox( $name = '', $value = '', $label='Title' , $desc ='', $attr= array() ){ 
			...
			<<?php echo $tag ?>  class="form-field term-<?php echo esc_attr ( $name ) ?>-wrap">
    			...
    			<<?php echo $tag1 ?>><label for="<?php echo $name  ?>"><input id="<?php echo $name ?>" type="checkbox" name="<?php echo $name ?>" value="1" <?php checked(	$value , '1'); ?>  ><?php echo !empty( $label ) ? "$label ": ''; ?></label>
    	        	<?php echo self::desc($desc) ?>
    			</<?php echo $tag1 ?>>
    		</<?php echo $tag ?> >
